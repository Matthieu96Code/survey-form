...
**survey form** is my project from the admission trial.
...
- **allows users make a choice by checkbox**
- **allows users to leave a comment**
- **allows users submit the form**
...
```sh
  mkdir my-folder
  cd my-folder
  git clone https://github.com/Matthieu96Code/survey-form.git
```
...
- [ ] **show more styling**
- [ ] **show more descriptives imformation**
...
Feel free to check the [issues page](https://github.com/Matthieu96Code/survey-form/issues).
